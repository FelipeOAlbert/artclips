...
// in simulator we redefine to format for Interview Developer console
...
{\
	NSString * exceptionName = [@"org.interview." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.interview";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIInterviewNativeItemNone = -1, 
	UIInterviewNativeItemSpinner = -2,
	UIInterviewNativeItemProgressBar = -3,
	
	UIInterviewNativeItemSlider = -4,
	UIInterviewNativeItemSwitch = -5,
	UIInterviewNativeItemMultiButton = -6,
	UIInterviewNativeItemSegmented = -7,
	
	UIInterviewNativeItemTextView = -8,
	UIInterviewNativeItemTextField = -9,
	UIInterviewNativeItemSearchBar = -10,
	
	UIInterviewNativeItemPicker = -11,
	UIInterviewNativeItemDatePicker = -12,
	
	UIInterviewNativeItemInfoLight = -13,
	UIInterviewNativeItemInfoDark = -14,
	
	UIInterviewNativeItemDisclosure = -15,
	
	UIInterviewNativeItemContactAdd = -16
};
