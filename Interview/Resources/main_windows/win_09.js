...
voltar_btn.addEventListener('click', function(e) {
	...
	Ti.App.fireEvent('win_08',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd});
...
avancar_btn.addEventListener('click', function(e) {
	...
	if (aCheck.selected)
	{
		...
		Ti.App.fireEvent('win_10',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:aCheck.label});
	}
	...
	else if (bCheck.selected)
	{
		...
		Ti.App.fireEvent('win_10',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:bCheck.label});
	}
	...
	else if (cCheck.selected)
	{
		...
		Ti.App.fireEvent('win_10',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:cCheck.label});
	}
	...
	else if (dCheck.selected)
	{
		...
		Ti.App.fireEvent('win_10',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:dCheck.label});
	}
	...
	else if (eCheck.selected)
	{
		...
		Ti.App.fireEvent('win_10',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:eCheck.label});
	}
	...
	else if (fCheck.selected)
	{
		...
		Ti.App.fireEvent('win_10',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:fCheck.label});
	}
	...
	else
	{
		...
		Ti.App.fireEvent('win_10',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:gCheck.label});
	}
