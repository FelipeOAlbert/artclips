...
voltar_btn.addEventListener('click', function(e) {
	...
	Ti.App.fireEvent('win_07',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura});
...
avancar_btn.addEventListener('click', function(e) {
	...
	if (aCheck.selected)
	{
		...
		Ti.App.fireEvent('win_09',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:aCheck.label});
	}
	...
	else if (bCheck.selected)
	{
		...
		Ti.App.fireEvent('win_09',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:bCheck.label});
	}
	...
	else if (cCheck.selected)
	{
		...
		Ti.App.fireEvent('win_09',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:cCheck.label});
	}
	...
	else if (dCheck.selected)
	{
		...
		Ti.App.fireEvent('win_09',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:dCheck.label});
	}
	...
	else if (eCheck.selected)
	{
		...
		Ti.App.fireEvent('win_09',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:eCheck.label});
	}
	...
	else
	{
		...
		Ti.App.fireEvent('win_09',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:fCheck.label});
	}
