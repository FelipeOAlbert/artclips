...
win.add(topView);
	...
	topView.add(questionView);
		...
		var question_text = Ti.UI.createLabel({
			text: 'Quanto pretende pagar pelo im\363vel?',
			font: {
				fontSize: 40,
				fontFamily: 'Georgia'
			},
		...
		var aCheck = Ti.UI.createView({
			...
			selected: false,
			label: 'at\351 99.999,00'
		});
		questionView.add(aCheck);
		
		//-- aLabel
		var aLabel = Ti.UI.createLabel({
			text: 'at\351 R$ 99.999,00',
			font: {
				fontSize: item,
				fontFamily: 'Georgia'
			},
		...
		var bCheck = Ti.UI.createView({
			...
			backgroundImage: '../images/radio_Btn.png',
			selected: false,
			label: 'de 100.000,00 at\351 129.999,00'
		});
		questionView.add(bCheck);
		
		//-- bLabel
		var bLabel = Ti.UI.createLabel({
			text: 'de R$ 100.000,00 at\351 R$ 129.999,00',
			font: {
				fontSize: item,
				fontFamily: 'Georgia'
			},
		...
		var cCheck = Ti.UI.createView({
			...
			backgroundImage: '../images/radio_Btn.png',
			selected: false,
			label: 'de 130.000,00 at\351 149.999,00'
		});
		questionView.add(cCheck);
		
		//-- cLabel
		var cLabel = Ti.UI.createLabel({
			text: 'de R$ 130.000,00 at\351 R$ 149.999,00',
			font: {
				fontSize: item,
				fontFamily: 'Georgia'
			},
		...
		var dCheck = Ti.UI.createView({
			...
			backgroundImage: '../images/radio_Btn.png',
			selected: false,
			label: 'de 150.000,00 at\351 179.999,00'
		});
		questionView.add(dCheck);
		
		//-- dLabel
		var dLabel = Ti.UI.createLabel({
			text: 'de R$ 150.000,00 at\351 R$ 179.999,00',
			font: {
				fontSize: item,
				fontFamily: 'Georgia'
			},
		...
		var eCheck = Ti.UI.createView({
			...
			backgroundImage: '../images/radio_Btn.png',
			selected: false,
			label: 'de 180.000,00 at\351 209.999,00'
		});
		questionView.add(eCheck);
		
		//-- eLabel
		var eLabel = Ti.UI.createLabel({
			text: 'de R$ 180.000,00 at\351 R$ 209.999,000',
			font: {
				fontSize: item,
				fontFamily: 'Georgia'
			},
		...
		var fCheck = Ti.UI.createView({
			...
			backgroundImage: '../images/radio_Btn.png',
			selected: false,
			label: 'de 210.000,00 at\351 239.999,00'
		});
		questionView.add(fCheck);
		
		//-- fLabel
		var fLabel = Ti.UI.createLabel({
			text: 'de R$ 210.000,00 at\351 R$ 239.999,00',
			font: {
				fontSize: item,
				fontFamily: 'Georgia'
			},
		...
		var gCheck = Ti.UI.createView({
			...
			backgroundImage: '../images/radio_Btn.png',
			selected: false,
			label: 'acima de 240.000,00'
		});
		questionView.add(gCheck);
		
		//-- gLabel
		var gLabel = Ti.UI.createLabel({
			text: 'acima de R$ 240.000,00',
			font: {
				fontSize: item,
				fontFamily: 'Georgia'
			},
...
voltar_btn.addEventListener('click', function(e) {
	...
	Ti.App.fireEvent('win_10',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam: win.rendaFam, fgts:win.fgts});
...
avancar_btn.addEventListener('click', function(e) {
	...
	if (aCheck.selected)
	{
		...
		Ti.App.fireEvent('win_13',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:win.fgts, financ:win.financ, tempFinanc:win.tempFinanc, pagarImovel:aCheck.label});
	...
	else if (bCheck.selected)
	{
		...
		Ti.App.fireEvent('win_13',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:win.fgts, financ:win.financ, tempFinanc:win.tempFinanc, pagarImovel:bCheck.label});
	}
	...
	else if (cCheck.selected)
	{
		...
		Ti.App.fireEvent('win_13',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:win.fgts, financ:win.financ, tempFinanc:win.tempFinanc, pagarImovel:cCheck.label});
	}
	...
	else if (dCheck.selected)
	{
		...
		Ti.App.fireEvent('win_13',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:win.fgts, financ:win.financ, tempFinanc:win.tempFinanc, pagarImovel:dCheck.label});
	}
	...
	else if (eCheck.selected)
	{
		...
		Ti.App.fireEvent('win_13',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:win.fgts, financ:win.financ, tempFinanc:win.tempFinanc, pagarImovel:eCheck.label});
	}
	...
	else if (fCheck.selected)
	{
		...
		Ti.App.fireEvent('win_13',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:win.fgts, financ:win.financ, tempFinanc:win.tempFinanc, pagarImovel:fCheck.label});
	}
