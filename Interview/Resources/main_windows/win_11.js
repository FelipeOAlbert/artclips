...
win.add(topView);
	...
	topView.add(questionView);
		...
		var question_text = Ti.UI.createLabel({
			text: 'Quanto tempo falta para quitar?',
			font: {
				fontSize: 40,
				fontFamily: 'Georgia'
			},
		...
		var aCheck = Ti.UI.createView({
			...
			selected: false,
			label: 'at\351 06 meses'
		});
		questionView.add(aCheck);
		
		//-- aLabel
		var aLabel = Ti.UI.createLabel({
			text: 'at\351 06 meses',
			font: {
				fontSize: item,
				fontFamily: 'Georgia'
			},
...
avancar_btn.addEventListener('click', function(e) {
	...
	if (aCheck.selected)
	{
		...
		Ti.App.fireEvent('win_12',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:win.fgts, financ:win.financ, tempFinanc:aCheck.label});
	}
	...
	else if (bCheck.selected)
	{
		...
		Ti.App.fireEvent('win_12',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:win.fgts, financ:win.financ, tempFinanc:bCheck.label});
	}
	...
	else if (cCheck.selected)
	{
		...
		Ti.App.fireEvent('win_12',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:win.fgts, financ:win.financ, tempFinanc:cCheck.label});
	}
	...
	else if (dCheck.selected)
	{
		...
		Ti.App.fireEvent('win_12',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:win.fgts, financ:win.financ, tempFinanc:dCheck.label});
	}
	...
	else
	{
		...
		Ti.App.fireEvent('win_12',{rg:win.rg, esc:win.esc, prof:win.prof, tempProcura:win.tempProcura, tipoImovel:win.tipoImovel, qntDorm:win.qntDorm, regProcura:win.regProcura, rendaInd:win.rendaInd, rendaFam:win.rendaFam, fgts:win.fgts, financ:win.financ, tempFinanc:eCheck.label});
	}	
